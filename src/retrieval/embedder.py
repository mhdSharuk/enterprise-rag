...
from src.retrieval.config import (EMBEDDING_MODEL, HF_TOKEN, EMBEDDING_ONNX_FILE, HYBRID_ALPHA)
...
def get_embeddings(dense_embedding_tokenizer, 
    ...
    if use_sparse:
        sparse_indices, sparse_values = get_sparse_embedding(pinecone_ref, text)
    else:

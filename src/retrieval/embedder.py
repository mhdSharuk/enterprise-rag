...
from src.retrieval.config import (DENSE_EMBEDDING_MODEL, DENSE_EMBEDDING_ONNX_FILE,
...
def load_dense_embedding_model():
    ...
    if DENSE_EMBEDDER_PATH.exists():
        ...
        local_file = DENSE_EMBEDDING_ONNX_FILE
...
def load_sparse_embedding_model():
    ...
    if SPARSE_EMBEDDER_PATH.exists():
        ...
        onnx_file = SPARSE_EMBEDDING_ONNX_FILE
        onnx_path = str(SPARSE_EMBEDDER_PATH / onnx_file)
    ...
    onnx_file = SPARSE_EMBEDDING_ONNX_FILE
    splade_session = ort.InferenceSession(
        str(SPARSE_EMBEDDER_PATH / onnx_file),
        sess_options=session_options,
        providers=[provider]
    )
